...
> module Language.Haskell.Codo(codo,context) where -- coextendR is only exported at the moment for illustration purposes but later should be hidden
...
> codoMain :: Exp -> Q Exp
> codoMain (LamE p bs) = [| $(codoMain' (LamE p bs)) . ($(fv "cmap") $(return $ projFun p)) |]
...
> mkProj gam (v, n) = valD (varP v) (normalB [| $(fv "cmap") $(prj n) $(gam) |]) []
